...
function Post(props) {
  ...
  const [curtidas, setCurtidas] = React.useState(props.num_curtidas)
...
/*
  ...
  console.log('props',props.numero_curtidas)
  curtidas = parseInt("props.num_curtidas")
  ...
  return (
    <div class="post">
      ...
      <div class="conteudo">
        <img onClick={curtir} src={props.imagem_conteudo} />
      </div>
      ...
      <div class="fundo">
        ...
        <div class="curtidas">
          <img src={props.imagem_curtidas} />
          <div class="texto">
            Curtido por <strong>respondeai</strong> e <strong>outras {props.numero_curtidas} pessoas</strong>
          </div>
        </div>
      </div>
    </div>
