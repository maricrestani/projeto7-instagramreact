...
function Post(props) {
  ...
  const [curtidas, setCurtidas] = React.useState(props.numero_curtidas)

  function salvar() {
    setSalvo(!salvo)
  }

  console.log('curtido1', curtido)
  console.log('props numero curtidas1', props.numero_curtidas)
  ...
  function aumentarCurtidas() {
    if (curtido === true) {
      curtidas = props.numero_curtidas++
